...
public class Teacher_List implements Serializable {
    ...
    public Teacher_List(String uId, String name, String id, String email, String phone, String department, String designation, String image, String office, String counseling, String initial) {
        this.uId = uId;
        this.name = name;
        this.id = id;
        this.email = email;
